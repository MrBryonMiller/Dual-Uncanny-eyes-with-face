...
//#include "graphics/terminatorEye.h"    // Standard human-ish hazel eye -OR-
...
#else
  {  9, 0, 1 }, // LEFT EYE display-select and wink pins, rotation = 1
  { 9, 0, 2 }, // RIGHT EYE display-select and wink pins, rotation = 2
#endif
};
...
// DISPLAY HARDWARE SETTINGS (screen type & connections) -------------------
 ...
 #include "Adafruit_HX8357.h"
  #define DISPLAY_DC        10    // Data/command pin for ALL displays
  #define DISPLAY_RESET     -1    // Reset pin for ALL displays
#endif

#if defined(_ADAFRUIT_ST7735H_) || defined(_ADAFRUIT_ST77XXH_) || defined(_ADAFRUIT_HX8357_H)
